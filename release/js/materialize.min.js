                ...
                return _inherits(s, Component), _createClass(s, [{
                    ...
                    value: function () {
                        ...
                        this.container = document.createElement("ul"), this.container.id = "autocomplete-options-" + M.guid(), h(this.container).addClass("autocomplete-content dropdown-content"), this.$inputField.append(this.container), this.el.setAttribute("data-target", this.container.id), this.dropdown = M.Dropdown.init(this.el, {
                            ...
                            onItemClick: function (t) {
                                e.clickedItem = t.innerText;
                                e.selectOption(h(t))
                                if(e.options.onItemSelect){
                                    e.options.onItemSelect(t);
                                }
                            }
                    ...
                    value: function () {
                        if(this.options.onBlur){
                            var nearestSubstitute = "";
                            var matchCount = this.el.nextElementSibling.children.length;
                            
                            if(matchCount > 0){
                                nearestSubstitute = this.el.nextElementSibling.children[0].innerText;
                            }
                            setTimeout(() => {
                                this.options.onBlur(nearestSubstitute, this.clickedItem);
                                this.clickedItem = "";
                            }, 160);
                        }
                        setTimeout(() => {
